...
#define TRANSFORM_COMPONENT_LUA_NAME "TransformComponent"
#define TRANSFORM_COMPONENT_LUA_FLAG "cfTransformComponent"
#define CHECK_TRANSFORM_COMPONENT(L, arg) static_cast<TransformComponent*>(CheckComponentLuaType(L, arg, TRANSFORM_COMPONENT_LUA_NAME, TRANSFORM_COMPONENT_LUA_FLAG));

struct TransformComponent_Lua
{
