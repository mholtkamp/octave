...
void LineEdit::InsertText(const std::string& text)
{
...
void LineEdit::DeleteCharacter(bool forward)
{
    if (!mEditable)
    {
        return;
...
void LineEdit::MoveCaret(int32_t delta, bool select)
{
    int32_t oldPos = mCaretPosition;
...
void LineEdit::MoveCaretToWordBoundary(int32_t direction, bool select)
{
    int32_t oldPos = mCaretPosition;
...
float LineEdit::GetCaretXPosition()
{
...
int32_t LineEdit::GetCharacterAtPosition(float x)
{
    Font* font = mText->GetFont();
    if (font == nullptr)
    {
...
void LineEdit::UpdateDisplayText()
{
...
void LineEdit::UpdateCaretVisual()
{
...
void LineEdit::UpdateSelectionVisual()
{
    if (!HasSelection())
    {
        mSelection->SetVisible(false);
...
void LineEdit::SetBackgroundTexture(Texture* texture)
{
...
Texture* LineEdit::GetBackgroundTexture()
{
    return mBackgroundTexture.Get<Texture>();
}

void LineEdit::SetBackgroundColor(glm::vec4 color)
{
...
glm::vec4 LineEdit::GetBackgroundColor()
{
    return mBackgroundColor;
}

void LineEdit::SetFocusedBackgroundColor(glm::vec4 color)
{
...
glm::vec4 LineEdit::GetFocusedBackgroundColor()
{
    return mFocusedBackgroundColor;
}

void LineEdit::SetTextColor(glm::vec4 color)
{
    if (mTextColor != color)
    {
        mTextColor = color;
...
glm::vec4 LineEdit::GetTextColor()
{
    return mTextColor;
}

void LineEdit::SetPlaceholderColor(glm::vec4 color)
{
...
glm::vec4 LineEdit::GetPlaceholderColor()
{
    return mPlaceholderColor;
}

void LineEdit::SetCaretColor(glm::vec4 color)
{
...
glm::vec4 LineEdit::GetCaretColor()
{
    return mCaretColor;
}

void LineEdit::SetSelectionColor(glm::vec4 color)
{
...
glm::vec4 LineEdit::GetSelectionColor()
{
    return mSelectionColor;
}

void LineEdit::SetTextPadding(float padding)
{
...
float LineEdit::GetTextPadding() const
{
    return mTextPadding;
}

Quad* LineEdit::GetBackground()
{
    return mBackground;
}

Text* LineEdit::GetTextWidget()
{
    return mText;
}

Quad* LineEdit::GetCaret()
{
    return mCaret;
}
