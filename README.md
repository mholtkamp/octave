...
For a more modern, greatly improved version of Octave, please check out Polyphase Engine:
https://github.com/Polyphase-Labs/Polyphase-Engine

Polyphase adds TONS of new features, such as:
 - Visual scripting
